...
/**
 * The Movies class extends Disk and implements the IDisk interface.
 */
public class Movies extends Disk implements IDisk {

    /**
     * The constructor for Movies class
     * @param name the name of the game
     * @param inventoryDate the date the game was added to the inventory
     * @param rating the rating of the game
     */
    public Movies(String name, Date inventoryDate, int rating){
        super(name, inventoryDate, rating, Type.MOVIE);
    }
