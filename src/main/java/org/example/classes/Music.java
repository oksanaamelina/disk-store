...
/**
 * The Music class extends Disk and implements the IDisk interface.
 */
public class Music extends Disk implements IDisk {

    /**
     * The constructor for Music class
     * @param name the name of the game
     * @param inventoryDate the date the game was added to the inventory
     * @param rating the rating of the game
     */
    public Music(String name, Date inventoryDate, int rating){
        super(name, inventoryDate, rating, Type.MUSIC);
    }
